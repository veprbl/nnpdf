...
def fit_cfactor_results_table(read_fit_cfactors):
    """
    Table generator to summarise information about the fit cfactors.

    The returned table contains information about the mean and the 
    standard deviation of the fit cfactors, as well as showing the 68%
    (95%) confidence level by computing mean +/- std (mean +/- 2*std). 
    """
